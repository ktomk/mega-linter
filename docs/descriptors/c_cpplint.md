...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'cuh', 'cu', 'h', 'hh', 'cpp', 'c++', 'hpp', 'cxx', 'c', 'hxx', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,cuh,cu,h,hh,cpp,c++,hpp,cxx,c,hxx,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'cuh', 'h', 'hh', 'hpp', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=h++,cuh,h,hh,hpp,hxx
        --headers=hpp,hxx
        --headers=hpp
